...
function addGamesToPage(games) {
    ...
    for (const i in games) {
        ...
        element.innerHTML = `<h3>${games[i].name}</h3>
                             ...
                             <p>\$${games[i].pledged.toLocaleString("en-US")} pledged</p>`;
...
const displayStr = `A total of \$${totalRaised.toLocaleString("en-US")}
                    ...
                    ${numUnfunded == 0 ? "Thank you for your support to fund these amazing games!" :
                        "We need your help to fund these amazing games!"}`;

// create a new DOM element containing the template string and append it to the description container
const descriptionCard = document.createElement("p");
descriptionCard.innerHTML = displayStr;
...
const firstGameCard = document.createElement("p");
firstGameCard.innerText = firstGame.name;
firstGameContainer.appendChild(firstGameCard);

// do the same for the runner up item
const secondGameCard = document.createElement("p");
secondGameCard.innerText = secondGame.name;
